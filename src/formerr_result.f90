...
contains
    ...
    pure elemental function ok_int(val) result(res)
        integer, intent(in) :: val
        type(result_type) :: res
        call res%set_right_int(val)
    end function ok_int

    pure elemental function err_int(val) result(res)
        integer, intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_int(this) result(val)
        class(result_type), intent(in) :: this
        integer :: val
    ...
    pure elemental function ok_i8(val) result(res)
        integer(int8), intent(in) :: val
        type(result_type) :: res
        call res%set_right_i8(val)
    end function ok_i8

    pure elemental function err_i8(val) result(res)
        integer(int8), intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_i8(this) result(val)
        class(result_type), intent(in) :: this
        integer(int8) :: val
    ...
    pure elemental function ok_i16(val) result(res)
        integer(int16), intent(in) :: val
        type(result_type) :: res
        call res%set_right_i16(val)
    end function ok_i16

    pure elemental function err_i16(val) result(res)
        integer(int16), intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_i16(this) result(val)
        class(result_type), intent(in) :: this
        integer(int16) :: val
    ...
    pure elemental function ok_i64(val) result(res)
        integer(int64), intent(in) :: val
        type(result_type) :: res
        call res%set_right_i64(val)
    end function ok_i64

    pure elemental function err_i64(val) result(res)
        integer(int64), intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_i64(this) result(val)
        class(result_type), intent(in) :: this
        integer(int64) :: val
    ...
    pure elemental function ok_real(val) result(res)
        real, intent(in) :: val
        type(result_type) :: res
        call res%set_right_real(val)
    end function ok_real

    pure elemental function err_real(val) result(res)
        real, intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_real(this) result(val)
        class(result_type), intent(in) :: this
        real :: val
    ...
    pure elemental function ok_r64(val) result(res)
        real(real64), intent(in) :: val
        type(result_type) :: res
        call res%set_right_r64(val)
    end function ok_r64

    pure elemental function err_r64(val) result(res)
        real(real64), intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_r64(this) result(val)
        class(result_type), intent(in) :: this
        real(real64) :: val
    ...
    pure elemental function ok_log(val) result(res)
        logical, intent(in) :: val
        type(result_type) :: res
        call res%set_right_log(val)
    end function ok_log

    pure elemental function err_log(val) result(res)
        logical, intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_log(this) result(val)
        class(result_type), intent(in) :: this
        logical :: val
    ...
    pure elemental function ok_cpx(val) result(res)
        complex, intent(in) :: val
        type(result_type) :: res
        call res%set_right_cpx(val)
    end function ok_cpx

    pure elemental function err_cpx(val) result(res)
        complex, intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_cpx(this) result(val)
        class(result_type), intent(in) :: this
        complex :: val
    ...
    pure elemental function ok_c64(val) result(res)
        complex(real64), intent(in) :: val
        type(result_type) :: res
        call res%set_right_c64(val)
    end function ok_c64

    pure elemental function err_c64(val) result(res)
        complex(real64), intent(in) :: val
        type(result_type) :: res
    ...
    pure elemental function unwrap_err_c64(this) result(val)
        class(result_type), intent(in) :: this
        complex(real64) :: val
